        ...
        function[ ] = KalmanFilter(condition)
           ...
           if(condition ==1)
            ...
            % step #0
                ...
                CritL = ones(NX, 1);
                CritL(1) = MepsL(1)*MepsL(1) + DepsL(1);
                CritL(NX) = MepsL(NX)*MepsL(NX) + DepsL(NX);
            ...
            if(condition == 1)
                ...
                for i = 1:K               
                    ...
                    sqrtCritToPlot(i) = CritLTable(1, 1, i);
            ...
            if(condition == 2)
                ...
                sqrtCrit1ToPlot(i) = CritLTable(1, 1, i);
                
                Sx2ToPlot(i) = SxTable(2, 1, i);
                Se2ToPlot(i) = SepsLTable(2, 1, i);
                sqrtCrit2ToPlot(i) = CritLTable(2, 1, i);
                tToPlot(i) = tTable(1, 1, i);
            end
            ...
            hold on;
            plot(tToPlot.', Se1ToPlot.');
            hold on;
            plot(tToPlot.', sqrtCrit1ToPlot.');
            legend('SxL1', 'SeL1', 'sqrtCritL1');
            
            subplot(1,2,2);
            plot(tToPlot.', Sx2ToPlot.');
            hold on;
            plot(tToPlot.', Se2ToPlot.');
            hold on;
            plot(tToPlot.', sqrtCrit2ToPlot.');
